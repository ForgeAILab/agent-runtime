...
- [ ] 0.1 Approve the native stateless Responses adapter, encrypted-reasoning
  replay, and conformance boundary.
- [ ] 0.2 Reconcile final types with `wire-provider-prompt-cache-2026-08-03`
...
- [ ] 1.1 Add bounded Responses request/input-item wire types and exact
  stateless canonical-history translation (`stream=true`, `store=false`,
  `include: ["reasoning.encrypted_content"]`).
- [ ] 1.2 Encode tools, tool choice, function results, images, structured
...
- [ ] 1.3 Enforce safe endpoint construction and refusal of storage,
...
- [ ] 2.1 Map reasoning output items onto signed `ContentPart::Reasoning`:
...
- [ ] 4.2 Add the adapter to reusable provider/runtime conformance and
...
- [ ] 4.3 Export the provider/config types and update README, changelog,
  migration notes, and crate documentation.
- [ ] 4.4 Run formatting, Clippy with warnings denied, focused tests,
