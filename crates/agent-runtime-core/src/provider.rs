...
mod identity;
pub use identity::{
    CacheEndpointIdentity, CacheIdentity, CacheIdentityBuilder, CacheIdentityFragment,
    CacheIdentityTool, CacheResourceIdentity,
};
...
#[cfg(test)]
mod tests {
    use super::identity::{MAX_ID_LABEL_BYTES, MAX_IDENTITY_TOOLS};
    use super::*;
