...
pub static PROVIDER_CATALOG: &[ProviderCatalogEntry] = &[
    ...
    ProviderCatalogEntry {
        ...
        default_env_var: Some("OLLAMA_API_KEY"),
    ...
    ProviderCatalogEntry {
        ...
        aliases: &["lm-studio"],
        auth_method: ProviderAuthMethod::None,
        default_env_var: Some("LM_STUDIO_API_KEY"),
    ...
    ProviderCatalogEntry {
        ...
        default_base_url: Some("https://api.synthetic.com"),
        default_model: None,
        requires_base_url: false,
        feature_gate: Some("compat"),
    ...
    ProviderCatalogEntry {
        ...
        auth_method: ProviderAuthMethod::ApiKey,
        default_env_var: Some("OPENCODE_API_KEY"),
    ...
    ProviderCatalogEntry {
        ...
        aliases: &[],
        auth_method: ProviderAuthMethod::ApiKey,
        default_env_var: Some("ASTRAI_API_KEY"),
        default_base_url: Some("https://as-trai.com/v1"),
        default_model: None,
        requires_base_url: false,
        feature_gate: Some("compat"),
        description: "as-trai",
